...
function getBotReply(msg) {
  ...
  if (txt.includes("halo") || txt.includes("hi")) return "Hai! Ada yang bisa saya bantu?";
  if (txt.includes("produk")) return "Lihat katalog produk kami di halaman utama ya!";
  if (txt.includes("bayar") || txt.includes("pembayaran")) return "Kami menerima transfer bank, e-wallet, dan COD.";
  return "Maaf, saya belum mengerti. Coba tanya hal lain ya 😊";
}
